...
routes.post(
  "/jornada/iniciar",
  AuthMiddleware,
  ProgressoController.iniciarJornada
);
...
routes.get('/tarefa/:tarefaId/gabarito', AuthMiddleware, TarefaController.buscarGabarito);
...
routes.post(
  ...
  AuthMiddleware,
  ProgressoController.responder
);

routes.post("/progresso/iniciar/:tarefaId", AuthMiddleware, ProgressoController.iniciar)

routes.post('/progresso/:progressoId/abandonar', ProgressoController.abandonar);

routes.get('/estatisticas', AuthMiddleware, ProgressoController.estatisticas);
